...
export const RIVERS: FeatureCollection<LineString, RiverProps> = {
  ...
  features: [
    { type: "Feature", properties: { name: "Ganga", type: "major", length: 2525, basin: "Ganga" }, geometry: { type: "LineString", coordinates: [[79.08, 30.99], [78.97, 30.45], [78.27, 30.11], [78.17, 29.95], [79.45, 28.45], [80.35, 26.85], [80.35, 26.45], [81.05, 25.95], [81.85, 25.43], [82.35, 25.35], [83.00, 25.32], [84.00, 25.40], [85.14, 25.59], [85.80, 25.50], [86.80, 25.15], [87.92, 24.85], [88.08, 24.10], [88.36, 22.57], [88.90, 21.80]] } },
