    ...
    <Suspense
      fallback={
        <div className="bg-warm-grid w-full min-h-screen flex items-center justify-center px-4 py-12 bg-[var(--background)]">
          <div className="w-full max-w-md rounded-[2rem] border border-[var(--border)] bg-[var(--background-secondary)] p-8 sm:p-12 shadow-[0_8px_30px_rgba(0,0,0,0.08)] text-center animate-pulse">
